<?php
    ...
    if(isset($_POST['insert_cat'])){
        ...
        $select_query="select * from tbl_brands where category_title='$category_title'";
        ...
        $insert_query ="INSERT INTO `tbl_brands`( `category_title`) VALUES ('$category_title')";
    ...
    <section class="main">
        ...
        <div class="table">
            ...
            <tr>
                ...
                <td><a href="cat_add.php?category_id=<?php echo $rows['category_id'];?>"><button style="color: White; background-color:green;">Activate</button></a></tb>
            </tr>
            <?php
                }
            ?>
