...
if(isset($_POST['insert_product'])){
    ...
    if($product_title=='' or $description=='' or $product_keywords=='' or  $ram=='' or
    ...
    `product_description`, `category_id`, 'brand_id','product_keywords','ram',
    `product_image1`, `product_image2`, `product_image3`, `product_price`,
    `date`, `status`) VALUES ('$product_title','$description',
    '$product_category', '$product_brands','$product_keywords','$ram',
