...
<body class="main-layout">
                            ...
                            <div class="limit-box">
                                <nav class="main-menu">
                                    <ul class="menu-area-main">
                                        ...
                                        <li><a href="sellerdashboard.php">sell</a></li>
                                        <a href="logout.php" style="color:white;">Welcome -<?php echo htmlentities($_SESSION['email']);?></a>
                                        <li class="last">
    ...
    <div class="brand">
        ...
        <div><img src="product_images/<?php echo $rows['product_image1'];?>" width="200px" height="300px"></div>
                ...
                <input type="submit" value="Buy Now" name="Buy Now" class="btn">
        </div>
        <?php
                }
            ?>
