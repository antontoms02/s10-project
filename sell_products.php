...
if(isset($_POST['insert_product'])){
    ...
    //insert query
    $insert_products="INSERT INTO `tbl_sell`(product_title, 
    product_description, category_id, brand_id,ram,processor,storage,qty,
    product_image1, product_image2, product_image3, product_price,
    date, status) VALUES ('$product_title','$description',
    '$product_category', '$product_brands','$ram','$processor','$storage','$qty',
...
<html lang="en">
    ...
    <div class="main--content">
        <div class="container mt-3">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <!--product keywords-->
                <div class="form-outline mb-4 w-50 m-auto">
                    <label for="product_keywords" class="form-label">purchased year</label>
                    <input type="text" name="purchased_year" id="purchased_year" class="form-control" 
                    placeholder="Enter purchased year" autocomplete="off" required>
                    <small></small>
                </div>
    ...
    <script src="productsval.js"></script>
    </body>
</html>